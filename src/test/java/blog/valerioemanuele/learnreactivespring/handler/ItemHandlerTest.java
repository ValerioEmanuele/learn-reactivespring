...
class ItemHandlerTest {
    ...
    void getItemById_notFound() {
        webTestClient.get().uri(ItemConstants.ITEM_FUNCTIONAL_END_POINT_V1.concat("/{id}"), "RTY")
            .exchange()
    ...
    void createItem() {
        ...
        webTestClient.put().uri(ItemConstants.ITEM_FUNCTIONAL_END_POINT_V1)
    ...
    void updateItem() {
        ...
        webTestClient.post().uri(ItemConstants.ITEM_FUNCTIONAL_END_POINT_V1.concat("/{id}"), "ABC")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    void updateItem_notFound() {
        ...
        webTestClient.post().uri(ItemConstants.ITEM_FUNCTIONAL_END_POINT_V1.concat("/{id}"), "ZAY")
            .contentType(MediaType.APPLICATION_JSON)
            .accept(MediaType.APPLICATION_JSON)
            .body(Mono.just(item), Item.class)
            .exchange()
