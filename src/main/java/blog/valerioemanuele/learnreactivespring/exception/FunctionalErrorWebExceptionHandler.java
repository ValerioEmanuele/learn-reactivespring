package blog.valerioemanuele.learnreactivespring.exception;
...
public class FunctionalErrorWebExceptionHandler extends AbstractErrorWebExceptionHandler {
    ...
    public FunctionalErrorWebExceptionHandler(ErrorAttributes errorAttributes, ApplicationContext applicationContext, ServerCodecConfigurer serverCodeConfigurer) {
    ...
    private Mono<ServerResponse> renderErrorResponse(ServerRequest serverRequest){
        ...
        log.info("errorAttributesMaps: " + errorAttributesMap );
